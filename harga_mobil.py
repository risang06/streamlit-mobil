...
# Load model pipeline
filename = 'harga_mobil.joblib'
pipeline = load(filename)

st.title("Prediksi Harga Mobil Bekas")

# Form input pengguna
model = st.selectbox("Model Mobil", ['Calya', 'Avanza', 'Xenia', 'Brio'])  # Sesuaikan jika ada model lain
...
bahan_bakar = st.selectbox("Bahan Bakar", ['bensin', 'diesel', 'hybrid', 'listrik'])  # Sesuaikan
